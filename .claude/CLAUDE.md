...
- `pdf/assets/seo.txt` - SEO keywords embedded in PDF metadata. Must not duplicate terms already present in `resume/resume.md`. After editing the resume, sync seo.txt: remove SEO terms that now appear in the resume, and consider adding SEO terms for concepts removed from it.
