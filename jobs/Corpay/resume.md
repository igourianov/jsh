...
Engineering Manager who builds teams, shapes product direction and owns delivery. Technical leader who stays hands-on in the codebase, from architecture to code review. Deep expertise in multi-tenant enterprise SaaS and regulated industries.

# Competencies

* **Technical leadership:** distributed architecture, system design, code reviews, technical mentorship, unit testing, relational database design
* **Tech stack:** Claude Code, C\#, .NET, .NET Core, ASP.NET MVC, JavaScript/TypeScript, MS SQL Server, microservices, event-driven architecture, HTTP web APIs (REST), CI/CD, Git, NUnit/xUnit
* **People leadership:** building and scaling teams, hiring, interviewing, mentoring, performance reviews, managing contractors
...
* Achieved zero voluntary attrition for 6 consecutive years, including through COVID remote transition. Consistently scored highest eNPS in the product organization for 5 years.
...
* Redesigned relational database schema upgrade process, cutting deployment time from 8+ hours to 30 minutes and eliminating 90% of merge conflicts.
