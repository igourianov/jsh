...
Hands-on Engineering Manager who has built and scaled high-performing full-stack teams delivering customer-facing features end-to-end. Player/coach who stays active in architecture, system design and code reviews while championing AI-augmented development with Claude Code. Deep expertise in complex multi-tenant enterprise SaaS at scale.

# Competencies

* **Technical leadership:** system design, architecture discussions, code reviews, technical mentorship, AI tooling adoption, hands-on full-stack development
* **People leadership:** hiring, mentoring, scaling teams, career development, performance management, leading remote teams
* **Product delivery:** cross-functional partnership with Product, UX and Architecture, roadmap planning, OKRs, SDLC ownership, rapid iteration cycles, DORA metrics, data-driven decision-making
* **Process:** Agile/Scrum, sprint planning, capacity planning, on-call rotations, blameless postmortems, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** Claude Code, React, JavaScript/TypeScript, Node.js, HTML/CSS, C#, .NET Core, ASP.NET MVC, SQL, microservices, event-driven architecture, REST APIs, Kubernetes (AKS), Docker, AWS/Azure, Terraform, Redis, ElasticSearch, Kafka, EntityFramework, Dapper, Prometheus+Grafana, CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium
...
* Championed AI tooling adoption: led AI-assisted migration of the frontend codebase from a legacy JS framework to a modern component framework using Claude Code, achieving 80% automated transformation and accelerating the modernization timeline.
* Stood up a platform team of 5 senior/staff engineers focused on monolith decomposition and core platform services.
* Drove architecture and system design discussions to extract a critical calculation engine from the monolith into an independently scalable microservice.
...
* Built the Talent Management suite from zero to 1,000+ enterprise customers through cross-functional partnership with Product and Design, contributing to DayforceHCM's recognition as a Gartner Leaders Quadrant recipient in Cloud HCM Suites.
...
* Led technical design and end-to-end delivery of a greenfield ATS (Applicant Tracking System), establishing the company's entry into HRTech and creating architectural patterns and core data models adopted across future HR products.
