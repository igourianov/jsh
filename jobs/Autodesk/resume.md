...
Engineering Manager who has built several high-performing engineering teams and customer-facing SaaS products from zero to general availability. Technical leader who stays hands-on in architecture decisions and code reviews, championing AI-augmented and AI-assisted development. Deep expertise in multi-tenant, cloud-native enterprise SaaS and leading globally distributed teams.

# Competencies

* **People leadership:** hiring, coaching and mentoring, career development, performance management, scaling teams, leading remote and globally distributed teams
* **Technical leadership:** system design and architecture, technical direction and mentorship, code reviews, AI tooling adoption and AI-assisted development with generative AI
* **Product delivery:** cross-functional partnership with Product, Design and Architecture, roadmap planning, OKRs, data-driven decision-making, DORA metrics, SDLC ownership
* **Process:** Agile/Scrum, on-call rotations and incident management, blameless postmortems, operational reliability, capacity planning, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** ReactJS, Node.js, JavaScript/TypeScript, HTML/CSS, AWS/Azure, Kubernetes (AKS), Docker, Terraform (IaC), microservices, event-driven architecture, distributed systems, Kafka, Redis, ElasticSearch, REST APIs, Claude Code, C\#, .NET Core, ASP.NET MVC, SQL Server, EntityFramework, Dapper, Prometheus+Grafana (observability), CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium
