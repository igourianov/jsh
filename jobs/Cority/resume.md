...
Engineering Manager who has built several high-performing engineering teams and products from zero to general availability. Hands-on technical leader who stays close to the code in architecture decisions and code reviews, championing AI-assisted development with tools like Claude Code. Deep expertise in multi-tenant enterprise SaaS on .NET and Angular, and in regulated, compliance-driven industries.

# Competencies

* **Technical leadership:** code reviews, system design and architecture, technical mentorship, AI tooling adoption (Claude Code), automated testing
* **People leadership:** hiring, performance management and career development, mentoring, scaling teams, leading remote teams
* **Product delivery:** delivery ownership, SDLC ownership, roadmap planning, cross-functional partnership with Product, QA, UX and Architecture, DORA metrics, data-driven decision-making, OKRs
* **Process:** Agile/Scrum, test automation, capacity planning, on-call rotations, blameless postmortems, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** Claude Code, C\#, .NET Core, .NET Framework, ASP.NET MVC, OOP, JavaScript/TypeScript, Angular, ReactJS, Node.js, HTML/CSS, SQL Server, stored procedures, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, Kubernetes (AKS), Docker, Terraform, Prometheus+Grafana, microservices, event-driven architecture, AWS/Azure, CI/CD, Azure DevOps, Git, REST APIs, NUnit/xUnit, Selenium
