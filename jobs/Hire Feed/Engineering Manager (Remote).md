...
- Collaborate with researcher clients on delivered work
- Maintain quality review processes for datasets
- Own project transitions from initiation to stable state
- Improve code quality within the team

## Company

HireFeed (a QuikHire product) is a job-aggregation platform, not the employer itself. It curates contract, gig and AI-training roles (RLHF, AI evaluation, domain-expert training, senior contract engineering) sourced from 500+ ATS feeds including Outlier, Mercor, Surge AI, Micro1, Turing, Toloka, Appen and Remotasks. It acts as a job board/aggregator; the actual employer for this specific role is an undisclosed "client".

## Keywords

Engineering Manager, RLHF, reinforcement learning from human feedback, supervised fine-tuning, large language models, LLM, Python, JavaScript, Java, dataset quality, code review, team management, delivery management, remote, technical leadership, people management
