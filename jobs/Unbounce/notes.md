...
- Merged with/acquired Insightly (CRM) in July 2024 - Insightly now operates as "an Unbounce Company."
- Rolled out Generative UI (AI landing page generation from text prompts) in March 2026 - matches "AI-native product" language in the JD.
- Not a technology/product term - confirmed as the actual hiring company.

**CloudX**
- Ambiguous, unresolved. Two distinct companies use this name:
  1. A nearshore software development company (cloudx.com, team mostly Latin America, developer-centric positioning).
  2. A separate "CloudX: AI-ready" consulting/AI solutions firm.
- No search result ties either directly to Unbounce.
- Possible (unconfirmed) explanation: CloudX may be the "third-party vendor" mentioned in the original JD whose engagement concludes August 2026 - the one this hire is meant to transition away from. Speculative, not verified.
- Still needs a direct answer from the recruiter.

**Infoway Software**
- Legitimate, established IT staffing firm, Middlesex County, NJ. Sources contract/permanent tech talent, digital/Cloud SaaS focus.
- Glassdoor: 4.3/5 (24 reviews), 92% would recommend, 4.5 for work-life balance and culture. No red flags.

**Amicus Systems Inc**
- Small software dev/staffing firm, Forest Hills, NY, ~10 employees, ~$12M revenue.
- Signature ties it to Infoway - appears to be an affiliated/co-branded entity, not a shell company.
