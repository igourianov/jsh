...
Engineering leader who builds and scales teams, shapes product direction and owns delivery, scaling orgs to 25+ engineers across multiple product teams. Technical leader who stays hands-on with architecture and code review, championing AI-augmented development. Deep expertise in multi-tenant enterprise SaaS and regulated industries.
...
* **Product delivery:** product roadmap planning, SDLC ownership, OKRs, metrics-driven leadership (DORA/DevEx metrics), cross-functional partnership with Product and UX
...
* **Tech stack:** Azure/AWS, Claude Code, C\#, .NET Core, ASP.NET MVC, JavaScript/TypeScript, Node.js, Python, Java, ReactJS, HTML/CSS, SQL Server, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, event-driven microservices, Kubernetes (AKS), Docker, Terraform, Prometheus+Grafana, CI/CD, Azure DevOps, Git, REST APIs, NUnit/xUnit, Selenium
...
* Built core platform services enabling other teams to transition to an event-driven microservices architecture.
