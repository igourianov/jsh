...
Engineering Manager who has built and scaled high-performing engineering teams, driving multi-quarter roadmap execution across competing product, compliance and operational priorities. Champions AI-assisted development and owns reliability, on-call and incident response practices. Deep expertise in multi-tenant enterprise SaaS and regulated industries, with strong cross-functional partnership across Product, Legal/Compliance and Operations.

# Competencies

* **People leadership:** hiring, performance management and career development, scaling teams, mentoring, leading remote teams, managing contractors
* **Product delivery:** roadmap planning, cross-functional partnership with Product, UX and Architecture, OKRs, SDLC ownership, DORA metrics, data-driven decision-making
* **Process:** on-call rotations, escalation triage and incident response, blameless postmortems and post-incident learning, Agile/Scrum, capacity planning, balancing feature/debt/KTLO work streams, SOC 2, GDPR, compliance
* **Technical leadership:** AI tooling adoption and AI developer tools, system design, backend architecture, service ownership, code reviews, technical mentorship
* **Tech stack:** Claude Code, Redis, AWS/Azure, C\#, .NET Core, ASP.NET MVC, JavaScript/TypeScript, Node.js, ReactJS, HTML/CSS, SQL Server, EntityFramework, Dapper, ElasticSearch, Kafka, Kubernetes (AKS), Docker, Terraform, Prometheus+Grafana, observability, microservices, distributed systems, event-driven architecture, CI/CD, Azure DevOps, Git, REST APIs, NUnit/xUnit, Selenium
