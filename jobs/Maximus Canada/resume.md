...
Engineering Leader who builds teams, shapes product direction and owns delivery. Scaled one team into three cross-functional product teams of up to 25 engineers, developed engineers into engineering managers and led AI-assisted modernization of enterprise SaaS. Technical leader who stays hands-on in the codebase, from architecture to code review, championing AI-augmented development. Deep expertise in multi-tenant enterprise SaaS and regulated industries.

# Competencies

* **People leadership:** building and scaling remote teams, hiring, mentoring, performance management, leadership development, succession planning, managing contractors
* **Process:** AI SDLC, Agile/Scrum, DevOps, capacity planning, workforce planning, on-call rotations, escalation triage and prioritization, incident response, blameless postmortems, balancing feature/debt/ops work streams, technical debt management, observability, SOC 2, GDPR, privacy, regulatory compliance
* **Product delivery:** roadmap planning, SDLC ownership, OKRs, engineering metrics (DORA/DevEx), cross-functional partnership with Product and UX
* **Technical leadership:** system design, code reviews, technical mentorship, AI-assisted engineering adoption
* **Tech stack:** Claude Code, SQL Server, microservices, REST APIs, AWS/Azure, Prometheus+Grafana, CI/CD
