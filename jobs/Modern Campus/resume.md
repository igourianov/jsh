...
Engineering leader who has built and scaled high-performing engineering organizations across multiple product teams, delivering enterprise SaaS from zero to general availability. Technical leader engaged in architecture, system design and platform decisions, championing AI-assisted and agentic development practices. Deep expertise in multi-tenant enterprise SaaS, modernization of legacy systems and foundational platform services.

# Competencies

* **Technical leadership:** system design, platform architecture, technical tradeoffs, shared services, code reviews, technical mentorship, AI tooling adoption, agentic SDLC
* **People leadership:** hiring, mentoring, scaling teams across multiple product areas, performance management, succession planning, career development, leading remote teams
* **Product delivery:** roadmap planning, delivery commitments, OKRs, SDLC ownership, DORA metrics, data-driven decision-making, cross-functional partnership with Product, UX and Architecture
* **Process:** Agile/Scrum, capacity planning, dependency management, on-call rotations, blameless postmortems, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** Claude Code, ReactJS, JavaScript/TypeScript, REST APIs, microservices, event-driven architecture, distributed systems, AWS/Azure, Kubernetes (AKS), Docker, Terraform, CI/CD, SQL Server, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, Prometheus+Grafana, C\#, .NET Core, ASP.NET MVC, Node.js, HTML/CSS, NUnit/xUnit, Selenium, Azure DevOps, Git
...
* Built core platform services enabling other product teams to transition to a microservices architecture.
