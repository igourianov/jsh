...
* **Technical leadership:** system design, code reviews, technical mentorship, AI adoption and AI-assisted engineering, agentic workflow guardrails
* **People leadership:** building and scaling remote teams, hiring, mentoring, performance management, managing contractors
* **Product delivery:** roadmap planning, SDLC ownership, release management, A/B testing, OKRs, DORA/DevEx metrics, cross-functional partnership with Product and UX
* **Process:** AI SDLC, Agile/Scrum, capacity planning, on-call rotations, incident response, escalation triage and prioritization, blameless postmortems, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** Claude Code, C\#, .NET Core, ASP.NET MVC, JavaScript/TypeScript, HTML/CSS, SQL Server, Entity Framework, microservices, REST APIs, CI/CD, Git, NUnit/xUnit, Selenium
...
* Scaled from one team to three cross-functional teams (8-12 devs+QA each), managing up to 25 engineers directly and via technical leads.
