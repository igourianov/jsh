...
Engineering Manager who has built and scaled multiple high-performing engineering teams and SaaS products from zero to general availability. Cross-functional leader who partners closely with Product, Design and stakeholders to align on roadmap priorities and drive platform scalability. Stays hands-on in architecture decisions and code reviews, championing AI-augmented development.

# Competencies

* **People leadership:** hiring, mentoring, scaling teams, performance management and career development, leading remote teams
...
* **Process:** Agile/Scrum, capacity planning, balancing feature/technical debt/ops work streams, blameless postmortems, on-call rotations, SOC 2, GDPR
* **Technical leadership:** system design, third-party integrations, code reviews, technical mentorship, AI tooling adoption
* **Tech stack:** ReactJS, JavaScript/TypeScript, Node.js, REST APIs, Claude Code, C\#, .NET Core, ASP.NET MVC, HTML/CSS, SQL Server, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, Kubernetes (AKS), Docker, Terraform, Prometheus+Grafana, microservices, event-driven architecture, AWS/Azure, CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium
