...
Engineering Manager who champions AI-assisted, agentic development and has built high-performing, distributed engineering teams and products from zero to general availability. Stays hands-on in architecture decisions and code reviews. Deep expertise in multi-tenant enterprise SaaS, regulated industries and healthcare-adjacent product delivery.

# Competencies

* **Technical leadership:** system design, distributed systems, code reviews, pull request reviews, technical mentorship, AI-assisted/agentic development tool adoption
...
* **Process:** Agile/Scrum, sprint planning, capacity planning, on-call rotations, production support, escalation triage and prioritization, blameless postmortems, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** Claude Code, C\#, .NET Core, ASP.NET MVC, REST APIs, cloud-native architectures, AWS/Azure, CI/CD, Azure DevOps, JavaScript/TypeScript, ReactJS, Angular, HTML/CSS, Node.js, SQL Server, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, Kubernetes (AKS), Docker, Terraform, Prometheus+Grafana, microservices, event-driven architecture, Git, NUnit/xUnit, Selenium
