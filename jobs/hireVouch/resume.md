...
Engineering Manager who stays hands-on in architecture, code reviews and C#/.NET delivery while building high-performing engineering teams and products from zero to general availability. Leads cloud migrations and drives AI-augmented development practices alongside the team. Deep expertise in multi-tenant enterprise SaaS and regulated industries.

# Competencies

* **Technical leadership:** system design, code reviews, technical mentorship, AI tooling adoption
* **People leadership:** hiring, mentoring, scaling teams, performance management, career development and retention, leading remote teams
* **Product delivery:** roadmap planning, release planning, OKRs, SDLC ownership, DORA metrics, data-driven decision-making, cross-functional partnership and stakeholder communication with Product, UX and Architecture
...
* **Tech stack:** C\#, .NET Core, ASP.NET MVC, SQL Server, EntityFramework, Dapper, Kafka, event-driven architecture, microservices, RESTful APIs, Azure/AWS, Kubernetes (AKS), Docker, Terraform, CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium, Redis, ElasticSearch, Prometheus+Grafana, JavaScript/TypeScript, Node.js, ReactJS, HTML/CSS, Claude Code
