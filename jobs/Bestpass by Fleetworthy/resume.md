...
Engineering Manager who has built several high-performing engineering teams and products from zero to general availability. Hands-on technical leader engaged in C#/.NET architecture, SQL Server schema and performance work, code reviews and production troubleshooting, championing AI-augmented development. Deep expertise in multi-tenant enterprise SaaS and regulated industries.

# Competencies

* **Technical leadership:** architect mindset, system design, code review, technical mentorship, AI coding tool adoption
* **People leadership:** hiring, mentoring, scaling teams, performance management and career development, leading distributed remote teams
* **Product delivery:** SDLC ownership, roadmap planning, OKRs, DORA metrics, data-driven decision-making, cross-functional partnership with Product, UX and Architecture
* **Process:** Agile/Scrum, coding standards, version control, release management, test coverage, observability, on-call rotations, blameless postmortems, capacity planning, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** C\#, .NET Core, ASP.NET MVC, SQL Server, EntityFramework, Dapper, Claude Code, microservices, event-driven architecture, REST APIs, Kubernetes (AKS), Docker, Terraform, Redis, ElasticSearch, Kafka, Prometheus+Grafana (observability), AWS/Azure, CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium, JavaScript/TypeScript, Node.js, ReactJS, HTML/CSS
...
* Extracted a critical calculation engine from the monolith into an independently scalable C#/.NET microservice.
...
* Scaled from one team to three cross-functional product teams (8-12 devs+QA each, 30+ engineers total). Designed the engineering interview process and hired 20+ engineers. Managed up to 25 engineers directly and via technical leads.
* Promoted 12 engineers across levels and developed 2 senior ICs into engineering managers now leading their own teams.
* Reduced customer-reported defects by 72% by improving the testing process and expanding unit, integration and end-to-end automated test coverage.
* Redesigned branching, version control and release process to eliminate cross-team environment conflicts, reducing deployment failures by 90% and enabling teams to ship independently.
...
* Redesigned SQL Server schema upgrade process, cutting deployment time from 8+ hours to 30 minutes and eliminating 90% of merge conflicts.
