...
Engineering Manager who has built several high-performing engineering teams and products from zero to general availability. Hands-on technical leader across backend and full stack, driving AI-assisted development and agentic workflows that measurably changed how teams build. Deep expertise in high-availability, multi-tenant SaaS at enterprise scale.

# Competencies

* **Technical leadership:** AI tooling adoption, agentic workflows, system design, architecture, code reviews, technical mentorship
* **People leadership:** hiring, mentoring senior and staff engineers, scaling teams, performance management and "career" development, leading remote teams, managing contractors
* **Product delivery:** roadmap planning, OKRs, cross-functional partnership with Product, UX and Architecture, SDLC ownership, DORA metrics, data-driven decision-making
...
* **Tech stack:** Claude Code, C\#, .NET Core, ASP.NET MVC, JavaScript/TypeScript, Node.js, ReactJS, HTML/CSS, microservices, event-driven architecture, REST APIs, AWS/Azure, Kubernetes (AKS), Docker, Terraform, Kafka, Redis, ElasticSearch, SQL Server, EntityFramework, Dapper, Prometheus+Grafana, CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium
...
* Led AI-assisted migration of the frontend codebase from a legacy JS framework to Angular using Claude Code and agentic workflows, achieving 80% automated transformation and accelerating the modernization timeline.
* Stood up and directly managed a platform team of 5 senior/staff engineers focused on monolith decomposition and core platform services.
...
* Delivered 20+ consumer-facing marketing web applications for healthcare industry leaders including Pfizer, AstraZeneca and Takeda
