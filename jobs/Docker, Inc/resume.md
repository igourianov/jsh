...
Engineering Manager who has built high-performing engineering teams and shipped products that won in market, from zero to general availability and 1,000+ enterprise customers. Technical leader who stays hands-on in architecture and code reviews, championing AI-augmented development with Claude Code. Deep expertise in multi-tenant enterprise SaaS with strong security, governance and compliance posture.

# Competencies

* **Product delivery:** cross-functional partnership with Product, UX and Architecture, product roadmap planning, customer-driven prioritization, OKRs, SDLC ownership, DORA metrics, data-driven decision-making
* **Technical leadership:** system design, architecture, code reviews, hands-on engineering, technical mentorship, AI tooling adoption (Claude Code)
* **People leadership:** hiring, mentoring senior ICs, scaling teams, performance management and career development, talent retention, leading remote and distributed teams
* **Process:** Agile/Scrum, predictable delivery, operational excellence, capacity planning, on-call rotations, blameless postmortems, balancing feature/debt/ops work streams, SOC 2, GDPR
* **Tech stack:** Docker, Kubernetes (AKS), containers, microservices, Claude Code, AI-augmented development, event-driven architecture, AWS/Azure, Terraform, IaC, Prometheus+Grafana, observability, CI/CD, REST APIs, C\#, .NET Core, ASP.NET MVC, JavaScript/TypeScript, Node.js, ReactJS, HTML/CSS, SQL Server, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, Azure DevOps, Git, NUnit/xUnit, Selenium
...
* Led AI-assisted migration of the frontend codebase from a legacy JS framework to Angular using the Claude Code AI agent, achieving 80% automated transformation and accelerating the modernization timeline.
