...
Engineering Manager who has built several high-performing engineering teams and fullstack products from zero to general availability. Technical leader who stays hands-on in architecture decisions, code reviews and system design, championing AI-augmented development with tools like Claude Code. Deep expertise in Node.js/JavaScript, React and relational databases, built across multi-tenant enterprise SaaS and regulated industries.

# Competencies

* **Technical leadership:** system design, software architecture, scalability, code reviews, technical mentorship, AI tooling adoption
* **People leadership:** mentoring, hiring, scaling teams, performance management and career development, leading remote teams, managing contractors
* **Product delivery:** cross-functional partnership with Product, UX and Architecture, product development, roadmap planning, OKRs, SDLC ownership, DORA metrics, data-driven decision-making
* **Process:** Agile/Scrum, on-call rotations and escalation triage, blameless postmortems, operational excellence and reliability, technical debt management, capacity planning, SOC 2, GDPR
* **Tech stack:** Claude Code, JavaScript/TypeScript, Node.js, ReactJS, HTML/CSS, SQL Server, EntityFramework, Dapper, AWS/Azure, REST APIs, C#, .NET Core, ASP.NET MVC, Redis, ElasticSearch, Kafka, Kubernetes (AKS), Docker, Terraform, Prometheus+Grafana, microservices, event-driven architecture, CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium
