...
Engineering Manager who has built several high-performing engineering teams and products from zero to general availability. Hands-on technical leader who stays close to architecture decisions and code reviews, driving modernization and championing AI-augmented development across the SDLC. Deep expertise in multi-tenant enterprise SaaS, distributed systems and regulated industries.

# Competencies

* **Technical leadership:** system design, secure system design, code reviews, technical mentorship, AI tooling adoption, modernization, developer experience
* **People leadership:** mentoring senior engineers, hiring, scaling teams, performance management and career development, leading remote teams
...
* **Product delivery:** roadmap planning, OKRs, SDLC ownership, cross-functional partnership with Product, UX and Architecture, DORA metrics, data-driven decision-making
* **Tech stack:** C\#, .NET Core, ASP.NET MVC, JavaScript/TypeScript, ReactJS, Node.js, REST API design, microservices, distributed systems, event-driven architecture, modular architecture, Kubernetes (AKS), Docker, containerization, ElasticSearch, Redis, SQL Server, EntityFramework, Dapper, data modeling, Kafka, Terraform (IaC), Prometheus+Grafana (observability, OpenTelemetry), AWS/Azure, CI/CD, Azure DevOps, Git, Claude Code, agentic AI, HTML/CSS, NUnit/xUnit, Selenium
...
* Stood up a platform team of 5 senior/staff engineers focused on monolith decomposition, modular architecture and core platform services.
