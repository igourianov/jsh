...
Engineering Manager who has built several high-performing engineering teams and B2B SaaS products from zero to general availability. Technical leader who stays hands-on in architecture decisions and code reviews, driving engineering excellence through metrics-driven delivery and AI-augmented development. Deep expertise in multi-tenant enterprise SaaS and regulated industries.

# Competencies

* **Technical leadership:** system design, architecture decisions, tech debt management, code reviews, technical mentorship, AI-assisted development
* **Process:** on-call rotations, escalation triage and prioritization, blameless postmortems, root cause analysis, shift-left testing, automation, Agile/Scrum, capacity planning, balancing feature/debt/ops work streams, SOC 2, GDPR
...
* **Product delivery:** roadmap planning, OKRs, SDLC ownership, DORA metrics (cycle time, MTTR), data-driven decision-making, cross-functional partnership with Product, UX and Architecture
* **Tech stack:** Claude Code, Node.js, ReactJS, JavaScript/TypeScript, Kubernetes (AKS), Git, REST APIs, CI/CD, C\#, .NET Core, ASP.NET MVC, HTML/CSS, SQL Server, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, Docker, Terraform, Prometheus+Grafana, microservices, event-driven architecture, AWS/Azure, Azure DevOps, NUnit/xUnit, Selenium
