...
Engineering leader who has built high-performing engineering teams and led large-scale platform modernization from legacy systems to modern architectures. Technical authority who stays hands-on in architecture decisions and code reviews, championing AI-augmented development. Deep expertise in multi-tenant enterprise SaaS and regulated, compliance-driven industries.

# Competencies

* **Technical leadership:** system design, architecture standards, legacy modernization, code reviews, secure development, technical mentorship, AI tooling adoption
* **People leadership:** hiring, mentoring, growing managers, scaling teams, performance management and career development, leading remote teams
* **Product delivery:** technical roadmap planning, OKRs, SDLC ownership, DORA metrics, stakeholder management, data-driven decision-making, cross-functional partnership with Product, UX and Architecture
* **Process:** Agile/Scrum, capacity planning, CI/CD, release management, on-call rotations, blameless postmortems, balancing feature/technical-debt/ops work streams, SOC 2, GDPR
* **Tech stack:** Claude Code, C\#, .NET Core, ASP.NET MVC, TypeScript/JavaScript, Angular, ReactJS, Node.js, SQL Server, EntityFramework, Dapper, REST APIs, web applications, microservices, event-driven architecture, Redis, ElasticSearch, Kafka, containerization (Docker), Kubernetes (AKS), Terraform (IaC), Prometheus+Grafana, AWS/Azure, CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium
...
* Led AI-assisted modernization of the frontend codebase from a legacy JS framework to Angular using Claude Code, achieving 80% automated transformation and accelerating the modernization timeline.
