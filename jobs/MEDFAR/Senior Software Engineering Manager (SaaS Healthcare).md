...
Senior Engineering Manager owning MEDFAR's foundational technical functions: Cloud Engineering and Core Architecture, plus SRE and DevOps. The role bridges platform strategy and technical execution, building a "platform-as-a-product" function that lets product teams ship faster through reusable capabilities and robust operational standards. Heavy emphasis on scaling reliable, maintainable cloud systems on a Microsoft stack (.NET, C#, SQL Server, Azure preferred), modernizing legacy/monolithic systems into cloud-native architectures, and maturing operations (IaC, backup/DR, observability, incident response, SLOs/SLIs).

- **Coding:** 0% - explicitly states "ability to engage in deep technical discussions with Staff Engineers and Architects without needing to write production code daily"; leadership and platform-strategy role
- Lead, coach and mentor Platform, SRE and DevOps engineers; own hiring, onboarding and performance management
- Define and execute the roadmap for shared services, developer enablement tools and cloud foundations
- Oversee cloud spend management (FinOps) and vendor relationships
- Strengthen production readiness, IaC, backup/DR and observability across Azure/AWS
- Evolve the incident response framework (escalation paths, RCAs) and define SLOs/SLIs and on-call practices
- Champion engineering standards for security, testability and maintainability; guide tech-debt reduction and modernization

## Company

MEDFAR Clinical Solutions, founded in 2010 in Montreal by two aeronautical engineers, builds cloud-based Electronic Medical Record (EMR) software for clinics. It was the first company to certify a cloud-based EMR in Canada. Its two products, MYLE (for general practitioners) and PLEXIA (for specialists), give physicians a single intuitive platform to access patient files and data, reduce clerical/administrative burden and support safer, better-informed care decisions. The company is a purpose-driven, high-growth SaaS organization (201-500 employees) focused on digitizing and modernizing healthcare in Canada and internationally, with offices around the world. R&D is done in partnership with doctors and healthcare administrators. Culture is described as transparent, collaborative and innovation-focused. Bilingual French/English operation is core to the company.
