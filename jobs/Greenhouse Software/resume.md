...
Engineering Manager who has built several high-performing engineering teams and recruiting technology products from zero to general availability, including an Applicant Tracking System and Talent Management suite serving 1,000+ enterprise customers. Technical leader who stays hands-on in architecture decisions and code reviews, championing AI-augmented development. Deep expertise in multi-tenant enterprise SaaS, RESTful API design and distributed system architecture.

# Competencies

* **People leadership:** hiring, scaling, performance management, mentoring engineers to senior levels, leading remote teams
* **Technical leadership:** system design, RESTful API architecture, distributed systems, code reviews, technical mentorship, AI tooling adoption
...
* Extracted a critical calculation engine from the monolith into an independently scalable microservice with RESTful APIs, enabling other teams to integrate without tight coupling.
...
* Built the Talent Management suite (recruiting, performance, compensation) from zero to 1,000+ enterprise customers, contributing to DayforceHCM's recognition as a Gartner Leaders Quadrant recipient in Cloud HCM Suites.
* Scaled from one team to three high-performing cross-functional product teams (8-12 devs+QA each, 30+ engineers total). Designed the engineering interview process and hired 20+ engineers. Mentored and promoted 12 engineers across levels, developing 2 senior ICs into engineering managers now leading their own teams.
...
* Led technical design and full-stack delivery of a greenfield Applicant Tracking System, building the company's first recruiting technology product from zero to general availability. Designed the data model, RESTful APIs and candidate pipeline workflows that set architectural patterns adopted across all subsequent HR products.
