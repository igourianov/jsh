...
Engineering Manager and hands-on technical leader who stays deep in architecture decisions and code reviews, championing AI-augmented development and agentic workflows, including a legacy modernization led with Claude Code. Deep expertise in multi-tenant enterprise SaaS and regulated industries.

# Competencies

* **Technical leadership:** software architecture, system design, code reviews, technical mentorship, AI-assisted development and agentic workflows, legacy modernization, full-stack engineering
* **People leadership:** mentoring, hiring, performance management and "career" development, leading remote teams, managing contractors, scaling teams
...
* **Process:** Agile/Scrum, capacity planning, on-call rotations, escalation triage and prioritization, blameless postmortems, balancing feature/debt/ops work streams, SOC 2, GDPR, DevSecOps
* **Tech stack:** Claude Code, coding agents, TypeScript/JavaScript, Node.js, ReactJS, C\#, .NET Core, ASP.NET MVC, HTML/CSS, SQL Server, EntityFramework, Dapper, Redis, ElasticSearch, Kafka, distributed systems, microservices, event-driven architecture, REST APIs, API design, cloud-native architecture, AWS/Azure, Kubernetes (AKS), containers, Docker, Terraform (IaC), Prometheus+Grafana (observability), CI/CD, Azure DevOps, Git, NUnit/xUnit, Selenium
