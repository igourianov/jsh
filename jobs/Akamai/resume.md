...
Engineering Leader with proven experience building and scaling high-performing remote teams in enterprise SaaS, delivering complex web applications with React, Angular, and TypeScript. Technical manager who stays engaged in UI architecture decisions, code reviews, and front-end engineering standards. Partnered with Product and UX/Design to deliver cohesive user experiences across multiple product areas. Helped scale Dayforce from emerging product to Gartner-recognized Cloud HCM leader.
...
* **Cross-functional collaboration:** Product, UX/Design, Architecture, and executive stakeholder partnership to deliver cohesive user experiences
* **Technical hands-on leadership:** UI architecture guidance, code reviews, front-end best practices, technical mentorship
* **Full-stack expertise:** React, Angular, TypeScript, JavaScript, HTML/CSS, .NET/C#, SQL, Kubernetes, microservices, AWS/Azure
* **Product delivery:** full project lifecycle ownership, roadmap planning, OKRs, SDLC, CI/CD, DORA metrics, release management
* **Testing & quality:** unit testing, functional testing, regression testing, CI pipelines, performance testing
* **Agile & process:** Scrum facilitation, capacity planning, balancing feature/debt/ops work streams
* **High-performance culture:** shared ownership, continuous improvement, engineering standards, eliminating process overhead
...
*Accomplishments:*
* Delivered three enterprise HCM products with rich web UIs (React, Angular, TypeScript) that helped position DayforceHCM as a Gartner Leaders Quadrant recipient in Cloud HCM Suites, serving Fortune 500 customers.
...
* Partnered with Product and UX/Design teams to drive consistency in user experiences across multiple product areas, establishing shared UI patterns and engineering standards.
...
*Skills/tools:* Agile/Scrum, Azure DevOps, Team building, Backlog grooming, .NET Core, C\#, SQL Server, JavaScript, TypeScript, HTML/CSS, ReactJS/Angular, Git, Kubernetes (AKS), High availability, Terraform, Cloud IaC, Docker, CI/CD, Service-oriented architecture (SOA), Microservices, Redis, Kafka, ElasticSearch, Prometheus+Grafana, GDPR, SOC 2 and PII compliance


### Lead Developer @ [Ceridian Inc / Dayforce](https://www.linkedin.com/company/dayforce/) | Mar 2013 \- Nov 2015

*Accomplishments:*
* Led technical design and delivery of Ceridian's first Recruiting module, establishing the company's entry into HRTech and creating UI component patterns and architectural conventions adopted across future HR products.
